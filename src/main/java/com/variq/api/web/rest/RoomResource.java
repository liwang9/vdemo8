...
import com.variq.api.repository.RoomRepository;
...
public class RoomResource {
    ...
    @GetMapping("/rooms")
    @Timed
    public ResponseEntity<List<Room>> getAllRooms(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
